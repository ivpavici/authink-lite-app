...
namespace AuthinkDEMO
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            {
                if(ApplicationData.Current.LocalSettings.Values["Language"] == null)
                {
                    ApplicationData.Current.LocalSettings.Values["Language"] = "En";
                }

                if (ApplicationData.Current.LocalSettings.Values["IsRewardSoundEnabled"] == null)
                {
                    ApplicationData.Current.LocalSettings.Values["IsRewardSoundEnabled"] = true;
                }
                if (ApplicationData.Current.LocalSettings.Values["IsInstructionSoundEnabled"]==null)
                {
