...
namespace AuthinkDEMO.Model.Data.External
{
    ...
    public class ApiAdapter : IDataProvider, ILoginService
    {
        public bool Login(string username,string password)
        {
            ...
            {
                var userLoginService_Url = string.Format("{0}{1}", apiRu::ApiDataSource.BaseUrl, apiRu::ApiDataSource.UserLogin);
        ...
        private string GetAllData_byUsername(string username)
        {
            using (var httpClient = new HttpClient())
            {
                ...
                var childDetails_Url = string.Format("{0}{1}{2}", apiRu::ApiDataSource.BaseUrl, apiRu::ApiDataSource.UsersChildren, username);
...
namespace AuthinkDEMO.Model.Data.External.Mappers
{
    ...
    public static class Task
    {
        public static ent::Task FromJsoNData(JObject taskData)
        {
            ...
            thumbUrl:     string.Format("{0}{1}", apiRU::ApiDataSource.BaseUrl, taskData.Value<string>("ProfilePictureUrl")),
